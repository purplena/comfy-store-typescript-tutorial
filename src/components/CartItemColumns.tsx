...
export const FirstColumn = ({image, title}: {title: string; image: string}) => {
  return <img className='h-24 w-24 rounded-lg sm:h-32 sm:w-32 object-cover' src={image} alt={title} />
}
